...
@XmlRootElement(name = "GetVillees", namespace = "http://tempuri.org/")
public class GetVillees {

    @XmlElementRef(name = "adress", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
