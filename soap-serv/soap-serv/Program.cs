...
namespace soap_serv
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Uri httpUrl = new Uri("http://localhost:8090/SoapServ/letsgobiking");



            //Create ServiceHost
            ServiceHost host = new ServiceHost(typeof(SoapServ), httpUrl);
            ...
            host.AddServiceEndpoint(typeof(ISoapServ), new BasicHttpBinding(), "");
